                  ...
                  if (isNaN(v)) {
                    ...
                    if (!attr.precision) {
                      if (!isValidScale(v, attr.scale)) {
                        var msg = createMessage(key, "scale", "error_scale", resource, attr.resource, attr.precision);
                        errors.push(createError(path, na, "scale", msg));
                      }
                    }
                    else {
                      if (!isValidPrecision(v, attr.precision, attr.scale)) {
                        var msg = createMessage(key, "precision", "error_precision", resource, attr.resource, attr.scale);
